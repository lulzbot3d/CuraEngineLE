...
class CuraEngineLEConan(ConanFile):
    ...
    topics = ("curale", "protobuf", "gcode", "c++", "curaengine", "libarcus", "gcode-generation", "3D-printing")
    exports = "LICENSE*"
    settings = "os", "compiler", "build_type", "arch"
    package_type = "application"
    python_requires = "sentrylibrary/1.0.0@lulzbot/stable", "npmpackage/[>=1.0.0]@lulzbot/stable"
